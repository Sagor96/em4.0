                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                      @foreach(Cart::content() as $r )
                        <tr>
                            <td>{{$r->model->eq_name}}</td>
                            <td><input class="form-control" type="text" value="{{$r->model->eq_qty}}" /></td>
                            <td class="text-right">{{$r->model->eq_cost}}</td>
                            <td class="text-right">
                              <form action="/cart/{{$r->rowId}}"method="post">
                                @csrf
                                @method('DELETE')
